...
ucf_crime_dir="/root/autodl-tmp/lavad-main/test"

# Set paths
root_path="${ucf_crime_dir}/frames2"
annotationfile_path="${ucf_crime_dir}/annotations/text2.txt"
...
context_prompt="your context_prompt"
